...
export default function AdminTopBar({ onPageChange }: AdminTopBarProps) {
  const { user } = useAuth();
        ...
        {!isMobile && (
          <div className="flex items-center">
            <div className="relative">
              ...
              <Input
                placeholder="Buscar..."
                className="w-80 pl-10 bg-slate-800 border-slate-600 text-white placeholder-slate-400 focus:border-red-500 mobile-input"
              />
            </div>
          </div>
        )}
              ...
              <div className="absolute right-0 mt-2 w-48 bg-slate-800 border border-slate-700 rounded-xl shadow-lg z-10">
                <div className="py-1">
                  <button 
                    ...
                    className="block w-full text-left px-4 py-2 text-slate-300 hover:bg-slate-700 hover:text-white transition-colors touch-target"
                  >
                    Ver Perfil
                  </button>
                  <button 
                  ...
                  <button
                    ...
                    className="block w-full text-left px-4 py-2 text-red-400 hover:bg-slate-700 hover:text-red-300 transition-colors touch-target"
                  >
                    Sair
                  </button>
                </div>
