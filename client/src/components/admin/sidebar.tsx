...
import { BarChart3, Users, Building, Link2, Webhook, DollarSign, PieChart, Settings, LogOut, Menu, X, ChevronLeft, ChevronRight, Activity, ExternalLink, Database, CreditCard } from "lucide-react";
...
export function AdminSidebar({ currentPage, onPageChange }: AdminSidebarProps) {
  ...
  const menuItems = [
    ...
    { id: "payments", label: "Gerenciar Pagamentos", icon: CreditCard },
