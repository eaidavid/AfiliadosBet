...
export default function PostbackLogs() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="lg:ml-72 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto transition-all duration-300 mt-[0px] mb-[0px] pt-[62px] pb-[160px] pl-[25px] pr-[25px] lg:ml-[110px] lg:mr-[110px]">
        <motion.div
